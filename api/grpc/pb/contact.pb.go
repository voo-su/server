...
const file_contact_proto_rawDesc = "" +
	"\n" +
	"\rcontact.proto\x12\acontact\"\x14\n" +
	"\x12GetContactsRequest\"A\n" +
	"\x13GetContactsResponse\x12*\n" +
	"\x05items\x18\x01 \x03(\v2\x14.contact.ContactItemR\x05items\"\x7f\n" +
	...
	"\asurname\x18\x05 \x01(\tR\asurname\x12\x16\n" +
	"\x06gender\x18\x06 \x01(\x05R\x06gender\x12\x14\n" +
	"\x05about\x18\a \x01(\tR\x05about\"3\n" +
	"\rSearchRequest\x12\f\n" +
	"\x01q\x18\x01 \x01(\tR\x01q\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x03R\x05limit\"<\n" +
	"\x0eSearchResponse\x12*\n" +
	"\x05items\x18\x01 \x03(\v2\x14.contact.ContactItemR\x05items2\xd9\x01\n" +
	"\x0eContactService\x12J\n" +
	"\vGetContacts\x12\x1b.contact.GetContactsRequest\x1a\x1c.contact.GetContactsResponse\"\x00\x12>\n" +
	"\aGetUser\x12\x17.contact.GetUserRequest\x1a\x18.contact.GetUserResponse\"\x00\x12;\n" +
	"\x06Search\x12\x16.contact.SearchRequest\x1a\x17.contact.SearchResponse\"\x00B\x1fZ\x1dvoo.su/api/grpc/pb/contact;pbb\x06proto3"
