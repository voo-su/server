...
type UserSearchResponse struct {
	...
	Items []*UserSearchResponse_Item `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
}
...
func (x *UserSearchResponse) GetItems() []*UserSearchResponse_Item {
	if x != nil {
		return x.Items
	}
	return nil
...
type UserSearchResponse_Item struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UserSearchResponse_Item) Reset() {
	*x = UserSearchResponse_Item{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserSearchResponse_Item) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSearchResponse_Item) ProtoMessage() {}

func (x *UserSearchResponse_Item) ProtoReflect() protoreflect.Message {
	mi := &file_v1_user_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSearchResponse_Item.ProtoReflect.Descriptor instead.
func (*UserSearchResponse_Item) Descriptor() ([]byte, []int) {
	return file_v1_user_proto_rawDescGZIP(), []int{1, 0}
}

func (x *UserSearchResponse_Item) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *UserSearchResponse_Item) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *UserSearchResponse_Item) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *UserSearchResponse_Item) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *UserSearchResponse_Item) GetSurname() string {
	if x != nil {
		return x.Surname
	}
	return ""
...
var file_v1_user_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x58, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x61, 0x72,
	0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x43, 0x0a, 0x08, 0x75, 0x73, 0x65,
	0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x27, 0x9a, 0x84, 0x9e,
	0x03, 0x22, 0x66, 0x6f, 0x72, 0x6d, 0x3a, 0x22, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65,
	0x22, 0x20, 0x62, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x3a, 0x22, 0x72, 0x65, 0x71, 0x75, 0x69,
	0x72, 0x65, 0x64, 0x22, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xc1,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65,
	0x61, 0x72, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x49, 0x74, 0x65,
	0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x1a, 0x78, 0x0a, 0x04, 0x49, 0x74, 0x65, 0x6d,
	...
	0x6d, 0x65, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f, 0x76, 0x31, 0x3b, 0x61, 0x70, 0x69, 0x5f, 0x76,
...
var file_v1_user_proto_goTypes = []any{
	(*UserSearchRequest)(nil),       // 0: v1.UserSearchRequest
	(*UserSearchResponse)(nil),      // 1: v1.UserSearchResponse
	(*UserSearchResponse_Item)(nil), // 2: v1.UserSearchResponse.Item
}
var file_v1_user_proto_depIdxs = []int32{
	2, // 0: v1.UserSearchResponse.items:type_name -> v1.UserSearchResponse.Item
...
func file_v1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_user_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*UserSearchResponse_Item); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
