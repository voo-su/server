...
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GroupChatOvertListResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GroupChatOvertListResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GroupChatOvertListResponseMultiError, or nil if none found.
func (m *GroupChatOvertListResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GroupChatOvertListResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetItems() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GroupChatOvertListResponseValidationError{
						field:  fmt.Sprintf("Items[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return GroupChatOvertListResponseValidationError{
					field:  fmt.Sprintf("Items[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GroupChatOvertListResponseMultiError(errors)
	}

	return nil
}

// GroupChatOvertListResponseMultiError is an error wrapping multiple
// validation errors returned by GroupChatOvertListResponse.ValidateAll() if
// the designated constraints aren't met.
type GroupChatOvertListResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GroupChatOvertListResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GroupChatOvertListResponseMultiError) AllErrors() []error { return m }

// GroupChatOvertListResponseValidationError is the validation error returned
// by GroupChatOvertListResponse.Validate if the designated constraints aren't met.
type GroupChatOvertListResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GroupChatOvertListResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GroupChatOvertListResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GroupChatOvertListResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GroupChatOvertListResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GroupChatOvertListResponseValidationError) ErrorName() string {
	return "GroupChatOvertListResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GroupChatOvertListResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGroupChatOvertListResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GroupChatOvertListResponseValidationError{}
...
// Validate checks the field values on GroupChatOvertListResponse_Item with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GroupChatOvertListResponse_Item) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GroupChatOvertListResponse_Item with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// GroupChatOvertListResponse_ItemMultiError, or nil if none found.
func (m *GroupChatOvertListResponse_Item) ValidateAll() error {
	return m.validate(true)
}

func (m *GroupChatOvertListResponse_Item) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GroupChatOvertListResponse_ItemMultiError(errors)
	}

	return nil
}

// GroupChatOvertListResponse_ItemMultiError is an error wrapping multiple
// validation errors returned by GroupChatOvertListResponse_Item.ValidateAll()
// if the designated constraints aren't met.
type GroupChatOvertListResponse_ItemMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GroupChatOvertListResponse_ItemMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GroupChatOvertListResponse_ItemMultiError) AllErrors() []error { return m }

// GroupChatOvertListResponse_ItemValidationError is the validation error
// returned by GroupChatOvertListResponse_Item.Validate if the designated
// constraints aren't met.
type GroupChatOvertListResponse_ItemValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GroupChatOvertListResponse_ItemValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GroupChatOvertListResponse_ItemValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GroupChatOvertListResponse_ItemValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GroupChatOvertListResponse_ItemValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GroupChatOvertListResponse_ItemValidationError) ErrorName() string {
	return "GroupChatOvertListResponse_ItemValidationError"
}

// Error satisfies the builtin error interface
func (e GroupChatOvertListResponse_ItemValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGroupChatOvertListResponse_Item.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GroupChatOvertListResponse_ItemValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GroupChatOvertListResponse_ItemValidationError{}
