...
func file_v1_upload_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_upload_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_upload_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_upload_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_upload_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_upload_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
