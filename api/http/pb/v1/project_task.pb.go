...
type ProjectTaskDetailResponse struct {
	...
	Assigner      *ProjectTaskDetailResponse_Member `protobuf:"bytes,5,opt,name=assigner,proto3" json:"assigner,omitempty"`
	Executor      *ProjectTaskDetailResponse_Member `protobuf:"bytes,6,opt,name=executor,proto3" json:"executor,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ProjectCoexecutorInviteRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TaskId        int64                  `protobuf:"varint,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	MemberIds     string                 `protobuf:"bytes,2,opt,name=member_ids,json=memberIds,proto3" json:"member_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
